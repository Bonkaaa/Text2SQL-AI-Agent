...
class DependencyScanner:
        ...
        for ecosystem in ecosystems:
            ...
            if scanner:
                ...
                results["vulnerabilities"].extend(
                    ecosystem_results.get("vulnerabilities", [])
                )
    ...
    def scan_npm(self) -> Dict[str, Any]:
        results = {"ecosystem": "npm", "vulnerabilities": []}
                    ...
                    results["vulnerabilities"].append(
                        {
                            ...
                            "cve": vuln.get("cves", []),
                            "fixed_in": vuln.get("fixAvailable", {}).get(
                                "version", "N/A"
                            ),
                            "source": "npm_audit",
                        }
    ...
    def scan_python(self) -> Dict[str, Any]:
        results = {"ecosystem": "python", "vulnerabilities": []}
    ...
    def scan_go(self) -> Dict[str, Any]:
        results = {"ecosystem": "go", "vulnerabilities": []}
    ...
    def scan_rust(self) -> Dict[str, Any]:
        results = {"ecosystem": "rust", "vulnerabilities": []}
    ...
    def generate_remediation_plan(self, vulnerabilities: List[Dict]) -> Dict[str, Any]:
        plan = {"immediate_actions": [], "short_term": [], "automation_scripts": {}}
...
class VulnerabilityPrioritizer:
    def calculate_priority_score(self, vulnerability: Dict) -> float:
        ...
        priority_score = cvss_score * 0.4 + exploitability * 2.0 + fix_available * 1.0
    ...
    def generate_sarif(self, scan_results: Dict[str, Any]) -> Dict[str, Any]:
        return {
            ...
            "runs": [
                {
                    "tool": {
                        "driver": {"name": "Dependency Scanner", "version": "1.0.0"}
                    },
                    "results": [
                        {
